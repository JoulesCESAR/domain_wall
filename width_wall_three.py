...
plt.xticks(arange(0.0,650.0,50.0), fontsize = 10)
plt.yticks(arange(0.0,2.0,0.2), fontsize = 9)

plt.plot(T, w0, '-',color = 'black',linewidth=1.2, label=r'\textit{$t = 0.2 nm$}')
plt.plot(T, w1, '--',color = 'blue',linewidth=1.2, label=r'\textit{$t = 0.5 nm$}')
plt.plot(T, w2, '-.',color = 'green', linewidth=1.2, label=r'\textit{$t = 0.7 nm$}')
plt.plot(T, w3, ':',color ='red',linewidth=1.2, label=r'\textit{$t = 0.73 nm$}')
...
plt.savefig('/home/julio/Documents/Development/domain_wall/Figures/figure8.jpg', figsize=(3.30, 3.30), dpi=100)
plt.show()
